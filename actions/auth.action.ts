...
async function sendVerificationEmail(email: string, otp: string) {
    try {
        await resend.emails.send({
            from: "Awaz.ai <noreply@awaz.ai>",
            to: email,
            subject: "Verify your email address - Awaz.ai",
...
async function sendPasswordResetEmail(email: string, resetToken: string) {
    ...
    try {
        await resend.emails.send({
            from: "Awaz.ai <noreply@awaz.ai>",
            to: email,
            subject: "Reset your password - Awaz.ai",
...
async function sendRegistrationSuccessEmail(email: string, name: string) {
    try {
        await resend.emails.send({
            from: "Awaz.ai <noreply@awaz.ai>",
            to: email,
            subject: "Welcome to Awaz.ai - Registration Complete! 🎉",
